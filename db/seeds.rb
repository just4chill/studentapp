...
# Weight.create!(ref: 1, w_val: 1000)
# Zigbee.create!(ref: 1, d_state: 0, s_val: 0)
...
Account.create!(card: "B", name: "person1", amount: 1000)
Account.create!(card: "C", name: "person1", amount: 1000)
Account.create!(card: "D", name: "person1", amount: 1000)
